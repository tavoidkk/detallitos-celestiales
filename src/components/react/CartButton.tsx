...
export default function CartButton() {
  ...
  return (
    <button
      ...
      className="relative inline-flex h-11 w-11 items-center justify-center rounded-full border border-celestial-border bg-celestial-surface text-celestial-ink hover:border-celestial-sky-500 hover:text-celestial-sky-700 transition-colors duration-150 tap-safe"
    >
